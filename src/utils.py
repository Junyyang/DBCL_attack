...
import numpy as np
from src.testing_LFWDataset import LFWDataset
from src.split_dataset import split
...
def sample_iid(dataset, num_users):
    '''
    Randomly shuffle the training data and dispense 
    training data to different users

    Generate random indices and random signs
    Args:
        dataset: training data, <class 'torchvision.datasets.mnist.MNIST'>
